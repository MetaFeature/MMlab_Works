...
data_root = '/home/ubuntu/Openmmlab/MMPose-0524/data/balloon/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/balloon_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/balloon_val.json',
...
val_evaluator = dict(ann_file=data_root + 'annotations/balloon_val.json')
